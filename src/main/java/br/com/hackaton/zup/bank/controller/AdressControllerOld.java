...
//public class AdressControllerOld {
//
//    @Autowired
...
//
//    Logger logger = LoggerFactory.getLogger(AdressControllerOld.class);
//
//    @GetMapping("/{id}")
//    @Transactional
...
//            logger.info("Proposal " + proposal.getId() + "associada ao adress : " + adress.getStreet());
//
